...
#[derive(Debug)]
pub struct PortalGlowProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PortalGlowProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PortalGlow processing");
    
    let mut processor = PortalGlowProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PortalGlowProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PortalGlowProcessor::new(false);
